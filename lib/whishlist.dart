...
class _WishlistState extends State<Whishlist> {
  ...
  //Methode permettant de recupéré les id des jeux de la whishlist de l'utilisateur
  Future<List<String>> getGameWhishlist() async {
    List<String> results = [];
    _getCurrentUser();
    String? user = _userId;
    try {
  ...
  Future getGameDataWishlist() async {
    String name = "";
    String prix = "";
    String editeur = "";
    String image = "";
    ...
    List<Game> games = [];
    List<String> idGames = await getGameWhishlist();
